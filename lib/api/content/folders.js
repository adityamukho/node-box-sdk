  ...
  Connection.addInstanceMethods(
    /** @lends Connection.prototype */
    {
      ...
      getFolderItems: function (id, opts, done, headers) {
        ...
        this._request(['folders', id, 'items'], 'get', done, opts, null, null, headers);
      },
      ...
      copyFolder: function (id, parent_id, name, done, headers) {
        ...
        this._request(['folders', id, 'copy'], 'post', done, null, opts, null, headers);
      },
      ...
      folderSharedLink: function (id, opts, done, headers) {
        ...
        this._request(['folders', id], 'put', done, null, {
          shared_link: opts
        }, null, headers);
      },
      ...
      getFolderCollaborations: function (id, done, headers) {
        ...
        this._request(['folders', id, 'collaborations'], 'get', done, null, null, null, headers);
      },
      ...
      getTrashedItems: function (opts, done, headers) {
        this._request(['folders', 'trash', 'items'], 'get', done, opts, null, null, headers);
      },
      ...
      getTrashedFolder: function (id, done, headers) {
        ...
        this._request(['folders', id, 'trash'], 'get', done, null, null, null, headers);
      },
      ...
      deleteTrashedFolder: function (id, done, headers) {
        ...
        this._request(['folders', id, 'trash'], 'del', done, null, null, null, headers);
      },
      ...
      restoreTrashedFolder: function (id, name, parent_id, done, headers) {
        ...
        this._request(['folders', id], 'post', done, null, opts, null, headers);
      }
    });
};