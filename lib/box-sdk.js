 ...
 * @property {string} [log-level] - Optional log level.
 * @see {@link https://www.npmjs.org/package/log#log-levels|Log Levels}
 */

/**
 * @class Box
 * @classdesc The Box object: One instance for each client. This is used to get connections.
 * @param {BoxInit} [opts] - Client parameters required for standalone operation. Can be omitted when running with [passport authentication middleware]{@link https://github.com/bluedge/passport-box}.
 */
var Box = base.createChild().addInstanceMethods({
	 ...
	 * @memberof Box#
	 * @param {string} - The email account identifier to connect to.
	 */
	...
	/**
	 * Used with Passport middleware. This function is used as a callback for the BoxStrategy.
	 * @memberof Box#
	 */
	...
	/**
	 * Called after a running standalone server is stopped.
	 *
	 * @callback stopServerCallback
	 ...
	 * @memberof Box#
	 * @param {stopServerCallback} callback - Called after asynchronously stopping the server.
	 */
...
/** Returns the {@link Box} prototype, instances of which represent a specific client.
 * @example
 * var box = box_sdk.Box({
 *   client_id: 'client id',
