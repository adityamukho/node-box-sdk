  ...
  Connection.addInstanceMethods(
    /** @lends Connection.prototype */
    {
      ...
      getFolderInfo: function (id, done, headers) {
        ...
        this._request(['folders', id], 'GET', done, null, null, null, headers);
      },
       ...
       * @param {requestCallback} done - The callback to invoke (with possible errors) when the request returns.
       */
      getFolderItems: function (id, opts, done) {
        if (!_.isNumber(parseInt(id, 10))) {
          return done(new Error('id must be specified.'));
        }
        this._request(['folders', id, 'items'], 'GET', done, opts);
      },
       ...
       * @param {requestCallback} done - The callback to invoke (with possible errors) when the request returns.
       */
      createFolder: function (name, parent_id, done) {
      ...
      updateFolder: function (id, fields, done, headers) {
        ...
        this._request(['folders', id], 'PUT', done, null, fields, null, headers);
      },
      ...
      deleteFolder: function (id, opts, done, headers) {
        ...
        this._request(['folders', id], 'DELETE', done, opts, null, null, headers);
      },
       ...
       * @param {requestCallback} done - The callback to invoke (with possible errors) when the request returns.
       */
      copyFolder: function (id, parent_id, name, done) {
        ...
        this._request(['folders', id, 'copy'], 'POST', done, null, opts);
      },
       ...
       * @param {requestCallback} done - The callback to invoke (with possible errors) when the request returns.
       */
      getFolderCollaborations: function (id, done) {
        if (!_.isNumber(parseInt(id, 10))) {
          return done(new Error('id must be specified.'));
        }
        this._request(['folders', id, 'collaborations'], 'GET', done);
      },
       ...
       * @param {requestCallback} done - The callback to invoke (with possible errors) when the request returns.
       */
      getTrashedItems: function (opts, done) {
        this._request(['folders', 'trash', 'items'], 'GET', done, opts);
      },
       ...
       * @param {requestCallback} done - The callback to invoke (with possible errors) when the request returns.
       */
      getTrashedFolder: function (id, done) {
        if (!_.isNumber(parseInt(id, 10))) {
          return done(new Error('id must be specified.'));
        }
        this._request(['folders', id, 'trash'], 'GET', done);
      },
       ...
       * @param {requestCallback} done - The callback to invoke (with possible errors) when the request returns.
       */
      deleteTrashedFolder: function (id, done) {
        if (!_.isNumber(parseInt(id, 10))) {
          return done(new Error('id must be specified.'));
        }
        this._request(['folders', id, 'trash'], 'DELETE', done);
      },
       ...
       * @param {requestCallback} done - The callback to invoke (with possible errors) when the request returns.
       */
      restoreTrashedFolder: function (id, name, parent_id, done) {
        ...
        this._request(['folders', id], 'POST', done, null, opts);
      }
    });
};