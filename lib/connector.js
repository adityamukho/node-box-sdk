...
var Connection = base.createChild().addInstanceMethods({
	 ...
	 * @see {@link https://developers.box.com/docs/#if-match|Content API Basics}
	 */

	/**
	 * An IncomingMessage object.
	 * @external IncomingMessage
	 * @see {@link http://nodejs.org/api/http.html#http_http_incomingmessage IncomingMessage}
	 */
	 ...
	 * @param {IncomingMessage} response - The response metadata.
	 * @param {*} body - The response body.
	 */

	/**
	 * Perform an HTTP request on this connection.
	 * Normally there is no need to call this function directly. Use one of the wrapper API methods instead.
	 * @memberof Connection#
...
/**
 * All {@link https://github.com/postaljs/monologue.js|Monologue} methods are mixed into the {@link Connection} object.
 * @external Monologue
 * @see {@link https://github.com/postaljs/monologue.js Monologue}
 */
